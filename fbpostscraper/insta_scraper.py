...
class InstaScraper:
    ...
    def get_posts(self, page, max_scrolls=10, date_from=None, date_to=None):
...
#        WebDriverWait(self.driver, timeout, 0.5).until(check_height)
    ...
    def scrape_post(self, e: WebElement) -> dict:
        ...
        article = dict(title=headline, date=date, text=msg, url=url, medium="Langstraatmedia")
